...
const repoName = "photokit-node";
const packageName = (pkg) => (pkg === "cli" ? repoName : `@${repoName}/${pkg}`);
    ...
    rules: {
        "package-boundary-imports": {
            ...
            create(context)
            {
                ...
                const currentPackageName = currentPackage ? packageName(currentPackage) : undefined;
